...
export default function Index({ suppliers }) {
    ...
    const handleDelete = (id, name) => {
        if (confirm(`Are you sure you want to delete supplier "${name}"?`)) {
            window.location.href = route('admin.suppliers.destroy', id);
        }
    };
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">Manage your material suppliers</p>
                                </div>
                                <Link
                            ...
                            {suppliers.length === 0 ? (
                                <div className="text-center py-12">
                                    <div className="text-gray-400 text-sm">No suppliers found. Start by adding your first supplier.</div>
                                </div>
                            ) : (
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-100">
                                                {suppliers.map((supplier) => (
                                                    <tr key={supplier.id} className="hover:bg-gray-50/40 transition-colors duration-150">
                                                        <td className="px-4 py-3.5 whitespace-nowrap text-sm font-medium text-gray-900">{supplier.name}</td>
